...
public class p183 {
    ...
    private static boolean isTerminatingDecimal(int n) {
        ...
        for (int b = 1; b <= n / 2; b++) {
            double lnb = (mem[b] == -1) ? (mem[b] = Math.log(b)) : mem[b], lnbm1 = (mem[b + 1] == -1) ? (mem[b + 1] = Math.log(b + 1)) : mem[b + 1];
        ...
        try {
            BigDecimal num = BigDecimal.valueOf(n), div = BigDecimal.valueOf(maxDiv);
